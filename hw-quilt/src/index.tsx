...
const color = GetColor(params);  // not used yet
const rows = GetRows(params);   // not used yet
...
if (pattern === undefined) {
  ...
  try {
    switch (pattern) {
      case "A": result = PatternA(rows, color); break;
      case "B": result = PatternB(rows, color); break;
      case "C": result = PatternC(rows, color); break;
      case "D": result = PatternD(rows, color); break;
      case "E": result = PatternE(rows, color); break;
